...
class BgcOutputer{
	public:
		...
		void outputCohortBgcVars_mly(BgcData *bgcod, FirData *fod, const int & calyr, const int & calmon, const int & recordcnt);
		void outputCohortBgcVars_yly(BgcData *bgcod, FirData *fod, const int & calyr, const int & recordcnt);
